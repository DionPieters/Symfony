 ...
 */
class Permission extends \clientsBundle\Entity\Permission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'clientsBundle\\Entity\\Permission' . "\0" . 'id', '' . "\0" . 'clientsBundle\\Entity\\Permission' . "\0" . 'name', '' . "\0" . 'clientsBundle\\Entity\\Permission' . "\0" . 'users');
        }
